                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" class="img_get" name="section1_image1" id="section1_image">
                                            ...
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" class="img_get" name="section3_image" id="section3_image">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 4: Service Introduction Section)</h4>
                                                <label class="form-label">Title</label>
                                            ...
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" class="img_get" name="section5_image" id="section5_image">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 6: FAQ's Section / 10 Faq's at a time)</h4>
                                                <label class="form-label">Title</label>
                                                ...
                                                <input type="file" class="img_get" name="section6_image" id="section6_image">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 7: Project Showcase Section / 6 Projects at a time)</h4>
                                                <label class="form-label">Title</label>
                                                ...
                                                <input type="file" class="img_get" name="section7_image1" id="section7_image1">
                                                ...
                                                <input type="file" class="img_get" name="section7_image2" id="section7_image2" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image3" id="section7_image3" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image4" id="section7_image4" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image5" id="section7_image5" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image6" id="section7_image6">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 8: User Experience Section)</h4>
                                                ...
                                                <input type="file" class="img_get" name="section8_image1" id="section8_image1" >
                                                ...
                                                <input type="file" class="img_get" name="section8_image2" id="section8_image2" >
                                                ...
                                                <input type="file" class="img_get" name="section8_image3" id="section8_image3" >
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on('click', '#save', function(e) {
                ...
                // Get all file input elements within the form
                const fileInputs = document.querySelectorAll('input[type="file"]');
                ...
                // If at least one file is uploaded, validate all file inputs
                if (hasUploadedFile) {
                    for (const fileInput of fileInputs) {
                        if (!fileInput.files.length) {
                            // Show a SweetAlert warning if any file input is empty
                            Swal.fire({
                                title: 'ERROR',
                                ...
                                if (result.isConfirmed) {
                                    // Focus on the first empty input (optional)
                                    fileInput.focus();
                                }
                            });
