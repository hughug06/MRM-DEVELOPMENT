                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" class="img_get" name="section1_image1" value="<?php echo $imageArray[0] ?>" id="section1_image">
                                            ...
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" class="img_get" name="section3_image" value="<?php echo $imageArray[1] ?>" id="section3_image">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 4: Service Introduction Section)</h4>
                                                <label class="form-label">Title</label>
                                            ...
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" class="img_get" name="section5_image" value="<?php echo $imageArray[2] ?>" id="section5_image">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 6: FAQ's Section / 10 Faq's at a time)</h4>
                                                <label class="form-label">Title</label>
                                                ...
                                                <input type="file" class="img_get" name="section6_image" value="<?php echo $imageArray[3] ?>" id="section6_image">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 7: Project Showcase Section / 6 Projects at a time)</h4>
                                                <label class="form-label">Title</label>
                                                ...
                                                <input type="file" class="img_get" name="section7_image1" value="<?php echo $imageArray[4] ?>" id="section7_image1">
                                                ...
                                                <input type="file" class="img_get" name="section7_image2" value="<?php echo $imageArray[5] ?>" id="section7_image2" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image3" value="<?php echo $imageArray[6] ?>" id="section7_image3" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image4" value="<?php echo $imageArray[7] ?>" id="section7_image4" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image5" value="<?php echo $imageArray[8] ?>" id="section7_image5" >
                                                ...
                                                <input type="file" class="img_get" name="section7_image6" value="<?php echo $imageArray[9] ?>" id="section7_image6">
                                            </div>
                                            <div class="mb-4 border p-3 rounded-3">
                                                <h4>(Section 8: User Experience Section)</h4>
                                                ...
                                                <input type="file" class="img_get" name="section8_image1" value="<?php echo $imageArray[10] ?>" id="section8_image1" >
                                                ...
                                                <input type="file" class="img_get" name="section8_image2" value="<?php echo $imageArray[11] ?>" id="section8_image2" >
                                                ...
                                                <input type="file" class="img_get" name="section8_image3" value="<?php echo $imageArray[12] ?>" id="section8_image3" >
                                            </div>
