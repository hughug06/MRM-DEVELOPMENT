                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="mb-4 border p-3 rounded-3">
                                                ...
                                                <input type="file" name="section1_image1" id="section1_image1" required>
                                                <input type="file" name="section1_image2" id="section1_image2" required>
                                                <input type="file" name="section1_image3" id="section1_image3" required>
