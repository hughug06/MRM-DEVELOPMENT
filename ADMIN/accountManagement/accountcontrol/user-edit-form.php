                                    ...
                                    <div class="row">
                                        ...
                                        <input type="hidden" id="id" name="id" value="<?php echo $id; ?>" class="form-control">
                                            ...
                                            <input type="text" class="form-control" placeholder="First name"
                                                aria-label="Full Name" id="firstname" name="firstname" required value="<?= $firstname?>" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')">
                                        </div>
                                        <div class="col-xl-12 mb-3">
                                            <label class="form-label">Last Name</label>
                                            <input type="text" class="form-control" placeholder="Last name"
                                                aria-label="Username" id="lastname" name="lastname" required value="<?= $lastname?>" oninput="this.value = this.value.replace(/[^A-Za-z\s]/g, '')">
                                        </div>
                                        <div class="col-xl-12 mb-3">
