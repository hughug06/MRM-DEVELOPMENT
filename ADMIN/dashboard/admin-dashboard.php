...
<html lang="en" dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark" data-toggled="close">
  ...
  <div id="chatWindow" style="display:none;">
    <h2>Chat with: <span id="clientName"></span></h2>
    <div id="messages"></div>
    ...
    async function fetchChats() {
      ...
      chats.forEach(chat => {
        ...
        chatItem.innerText = chat.client.name;
        chatItem.onclick = () => openChat(chat.chat_id, chat.client.name);
        chatList.appendChild(chatItem);
      });
    }

    // Open chat window
    async function openChat(chatId, clientName) {
    ...
    async function sendMessage() {
      const chatId = 'CHAT_ID_HERE'; // Replace with the current chat ID
      ...
      messageInput.value = '';
      openChat(chatId, document.getElementById('clientName').innerText);
    }
