        ...
        <div class="row mb-4">
          <div class="col-md-4">
            <div class="card border-0">
              ...
              />
              <div class="card-body">
                  <a href="assets/landing_assets/images/mrm_permits/img5.jpg" class="article.html btn btn-secondary d-flex mx-auto text-light"><p class="text-center">View Image</p></a>
              </div>
            </div>
          </div>
          <div class="col-md-4">
