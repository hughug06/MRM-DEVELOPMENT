...
function switcherClick() {
    ...
    //     localStorage.setItem("primaryRGB", "255, 255, 255");
    //     localStorage.setItem('bodyBgRGB', "255, 255, 255");
    //     updateColors();
    // });
    window.onload = () => {
        localStorage.setItem("primaryRGB", "214, 150, 14 ");
       
        document.documentElement.style.setProperty('--primary-rgb', `214, 150, 14 `);
        updateColors();
    };
    // primary theme
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("spruharegular", true);
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("spruhaclassic", true);
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("spruhamodern", true);
        localStorage.removeItem("spruharegular");
        localStorage.removeItem("spruhaclassic");
    });
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("spruhalayout");
...
function lightFn() {
    ...
    localStorage.removeItem("spruhabgColor");
    localStorage.removeItem("spruhaheaderbg");
    localStorage.removeItem("spruhabgwhite");
    localStorage.removeItem("spruhamenubg");
    localStorage.removeItem("spruhamenubg");
    checkOptions();
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('spruhaHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('spruhaHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('spruhaHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('spruhaHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('spruhaHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('spruhaMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('spruhaMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('spruhaMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('spruhaMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('spruhaMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('spruhaboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('spruhaheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('spruhamenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('spruhaheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('spruhamenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('spruhaclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('spruhamodern')) {
