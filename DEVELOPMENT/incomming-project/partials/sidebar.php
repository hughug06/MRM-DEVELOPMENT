    ...
    <nav class="main-menu-container nav nav-pills flex-column sub-open">
        ...
        <ul class="main-menu">   
            ...
            <li class="slide">
                <a href="services-installation.php" class="side-menu__item">
                    ...
                    <span class="shape2"></span>
                    <i class="fa fa-address-book side-menu__icon"></i>
                    <span class="side-menu__label">Installation</span>
                </a>
            </li>
            <!-- End::slide -->
            ...
            <!-- Start::slide -->
            <li class="slide">
                <a href="services-tune-up.php" class="side-menu__item">
                    <span class="shape1"></span>
                    <span class="shape2"></span>
                    <i class="fa fa-address-book side-menu__icon"></i>
                    <span class="side-menu__label">Tune up</span>
                </a>
            </li>
            <!-- End::slide -->
            ...
            <!-- Start::slide -->
            <li class="slide">
                <a href="services-repair.php" class="side-menu__item">
                    <span class="shape1"></span>
                    <span class="shape2"></span>
                    <i class="fa fa-address-book side-menu__icon"></i>
                    <span class="side-menu__label">Repair</span>
                </a>
            </li>
            <!-- End::slide -->
        <!-- Start::slide__category -->
        <li class="slide__category"><span class="category-name">Inquire/Schedule</span></li>
         <!-- End::slide__category -->
             ...
             <!-- Start::slide -->
             <li class="slide">
                <a href="user-forum.php" class="side-menu__item">
                    <span class="shape1"></span>
                    <span class="shape2"></span>
            ...
            <!-- Start::slide -->
            <li class="slide">
                <a href="user-account-settings.php" class="side-menu__item">
                    <span class="shape1"></span>
                    <span class="shape2"></span>
