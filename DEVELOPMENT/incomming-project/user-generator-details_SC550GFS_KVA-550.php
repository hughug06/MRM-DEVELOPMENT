                        ...
                        <div class="card custom-card productdesc">
                            <div class="card-body h-100">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-12">
                                        <div class="mt-4 mb-4">
                                            <h4 class="mt-1 mb-3">SC550GFS KVA550</h4>
                                                    ...
                                                    <table class="table mb-0 border table-bordered text-nowrap">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>1.5 hours at full load, 2.5 hours at half load</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Noise Level:</th>
                                                                <td>99 dB at 7 meters</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Dimensions:</th>
                                                                <td>480 cm (L) x 260 cm (W) x 280 cm (H)</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>45 x 120V, 18 x 240V, 18 x USB ports</td>
                                                            </tr>
                                                            <tr>
