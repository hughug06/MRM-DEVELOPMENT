                        ...
                        <div class="card custom-card productdesc">
                            <div class="card-body h-100">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-12">
                                        <div class="mt-4 mb-4">
                                            <h4 class="mt-1 mb-3">SC100GFS KVA100</h4>
                                                    ...
                                                    <table class="table mb-0 border table-bordered text-nowrap">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>5 hours at full load, 9 hours at half load</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Noise Level:</th>
                                                                <td>80 dB at 7 meters</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Dimensions:</th>
                                                                <td>260 cm (L) x 130 cm (W) x 150 cm (H)</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>10 x 120V, 4 x 240V, 3 x USB ports</td>
                                                            </tr>
                                                            <tr>
