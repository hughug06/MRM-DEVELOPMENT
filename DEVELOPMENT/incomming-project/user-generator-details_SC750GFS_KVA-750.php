                        ...
                        <div class="card custom-card productdesc">
                            <div class="card-body h-100">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6 col-lg-12 col-md-12">
                                        <div class="mt-4 mb-4">
                                            <h4 class="mt-1 mb-3">SC750GFS KVA750</h4>
                                                    ...
                                                    <table class="table mb-0 border table-bordered text-nowrap">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>1 hour at full load, 1.5 hours at half load</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Noise Level:</th>
                                                                <td>104 dB at 7 meters</td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">Dimensions:</th>
                                                                <td>550 cm (L) x 300 cm (W) x 320 cm (H)</td>
                                                            </tr>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>60 x 120V, 25 x 240V, 25 x USB ports</td>
                                                            </tr>
                                                            <tr>
